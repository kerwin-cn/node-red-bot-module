...
const Taobao_1 = __importDefault(require("../Providers/Taobao"));
const Gitee_1 = __importDefault(require("../Providers/Gitee"));
const Coding_1 = __importDefault(require("../Providers/Coding"));
class SocialiteManager {
    constructor(config) {
        ...
        this.providers = {
            ...
            [Taobao_1.default.NAME]: Taobao_1.default,
            [Gitee_1.default.NAME]: Gitee_1.default,
            [Coding_1.default.NAME]: Coding_1.default,
        };
